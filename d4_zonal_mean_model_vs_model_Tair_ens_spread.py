...
ax1.plot(lat[:],zm_tair_AMIP_diff_DJF[:],color="b",lw=2,ls="-")
ax1.plot(lat[:],zm_ensmean_tair_diff_DJF[:],color="r",lw=2,ls="-")
...
ax1.set_ylabel("Delt_SAT",fontsize=12)
...
ax2=fig.add_axes([0.6,0.15,0.3,0.4])
ax2.plot(lat[:],zm_tair_AMIP_diff_JJA[:],color="b",lw=2,ls="-")
ax2.plot(lat[:],zm_ensmean_tair_diff_JJA[:],color="r",lw=2,ls="-")
ax2.plot(lat[:],zeros[:],color="gray",lw=1,ls="-")

ax2.set_title("DJF",fontsize=14) #+var_long_name,fontsize=12)
ax2.set_ylabel("Delt_SAT",fontsize=12)
