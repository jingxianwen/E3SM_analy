...
ax1.plot(lat[:],zm_tair_AMIP_diff_DJF[:],color="b",lw=2,ls="-",label="Scat - noScat, CMIP")
ax1.plot(lat[:],zm_ensmean_tair_diff_DJF[:],color="r",lw=2,ls="-",label="Scat - noScat, AMIP")
...
ax1.set_ylabel("\u0394SAT (K)",fontsize=12)
...
ax2.plot(lat[:],zm_tair_AMIP_diff_JJA[:],color="b",lw=2,ls="-",label="Scat - noScat, CMIP")
ax2.plot(lat[:],zm_ensmean_tair_diff_JJA[:],color="r",lw=2,ls="-",label="Scat - noScat, AMIP")
...
ax2.set_ylabel("\u0394SAT (K)",fontsize=12)
